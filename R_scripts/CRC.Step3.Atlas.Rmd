...
dir1 <- "/mnt/data1/elyas/Single-cell/LOY/Atlas/"
...
```{r Table}
male <- readRDS("/mnt/data1/elyas/Single-cell/LOY/Atlas/male.rds")
...
saveRDS(z,"/mnt/data1/elyas/Single-cell/LOY/Atlas/loy.perc.RDS")
```

```{r Plot LOY}
# Defining per cell type LOY percentage 

z <- readRDS("/mnt/data1/elyas/Single-cell/LOY/Atlas/loy.perc.RDS")
